...
public class XeParser {
    ...
    public ExchangeResult getRateXeCom(String from, String to) throws Exception {
        // Set request URL to google
        String request = "http://www.xe.com/fr/currencyconverter/convert/?From="+from+"&To="+to;
        String resultstr = "";
        Document doc = null;
        try {
            // Fetch DOM from google (Emulating browser request through user agent string)
            ...
            // Fetching element containing exchange rate data
            Element result = doc.select(".uccResultAmount").first();
